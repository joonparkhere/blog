...
![](images/equity-price-in-depression-phase.png)

일반적 침체기에는, 금리 인하 => 양의 자산 효과, 경제 활동 촉진, 부채 상환 부담 감소
그러나 불황기에는, 이미 금리 0% 도달 => 금리 인하 불가

![](images/nominal-short-rate-graph.png)
> - Nominal Short Rate: 명목 단기 금리
> - Tight: 긴축
> - Easy: 완화

불황 => 채무 불이행 & 채무 재조정 => 공포 (재산이라 믿었던 것이, 그저 돈을 주겠다는 약속에 불가함을 깨달음) => 뱅크런
일반적으로 은행은 뱅크런을 감당할 만한 현금을 보유하지 않음

![](images/cash-reserve-ratio.png "예금 지급 준비율 from 한국은행")

대출 상환율 증가 && 자산 매각 => 유동성 약화
중앙은행은 양자택일의 상황에 놓임
- 돈 찍어내기로 시장에 유동성 공급
- 채무 불이행 늘어나도록 방관

정책 입안자들은 아래 수단으로 불황 극복을 시도
수단들의 적절한 조합을 찾아야 함
#### 1. 긴축
   보통 불황 국면에서 긴축부터 시도함
   (위기 자초 && 타인에게 손해 준 주체의 비용 부담이 당연하다고 여김)
   
   경기 위축 => 정부 세입 감소 && 정부 지출 증가 => 재정 적자 확대
   => 세금 인상
   
   긴축과 세금 인상은 모두 큰 실책
   
#### 2. 화폐 찍어내기 (부채의 화폐화, 양적 완화)
   뱅크런으로 인한 보호 및 구제 필요성
   정부 예산 && 중앙은행이 찍어낸 돈 으로 필요한 자금 충당
   
   다음으로, 신용 경색 (미래 불확실성으로 인해 돈을 제대로 공급하지 않음) 완화 및 경기 부양 필요성
   세금 && 국채 발행 방법으로 자금 조달에 어려움
   중앙은행은 돈을 찍어내어 국채를 사들임
   
   통화 정책 이외의 요소
   - 공포 해소와 지급 보증
   - 유동성 공급
   - 주요한 기관들의 지급 능력 지원
   - 주요한 금융기관의 자본 재구성, 국유화, 손실 보전
	
#### 3. 채무 불이행, 채무 재조정
   악성 부채 정리의 필요성
   주요하지 않은 금융기관은 손실을 고스란히 감수, 혹은 파산
   
   예금자 보호 기준
   - 예금 보호 제도: 소액 예금자 우대
   - 금융기관 파산시 주주, 후순위 채권 (Subordinated Debt) 소유자, 고액 예금자는 손해

#### 4. 부의 재분배
   이 시기에는 포퓰리즘이 판을 친다.
   부자 증세는 정치적으로 매력적인 수단이 됨
   부자들이 자산 보호 방법을 물색 => 시장 혼돈
   
   디레버리징에 큰 도움이 될 부의 재분배는 잘 일어나지 않음

### 아름다운 디레버리징

위의 4가지 정책의 균형있는 조합 => 충격 완화, 인플레이션 유발 (경제 성장), 부채 부담 감소 => 아름다운 디레버리징
- 인플레이션 세력 (화폐 찍어내기, 부채의 화폐화, 통화 평가절하) 이 충분히 강력해 
  디플레이션 세력 (긴축, 채무 불이행) 을 상쇄할 수 있어야 함
- 명목 성장률 >>> 명목 금리 수준으로 끌어올릴 수 있어야함
- 동시에, 인플레이션 가속 및 통화 가치 하락 (하이퍼인플레이션) 현상은 발생하면 안 됨

중앙은행은 유동성 공급을 통한 신용 지원
정부는 주요 경제 주체에게 자금 수요에 따른 유동성 공급

화폐 찍어내기가 인플레이션 유발?
화폐 찍어내기로 인해 유발되는 경기 부양 세력이 반대 세력과 균형을 이뤄
상쇄할 수 있으면 인플레이션은 유발되지 않음

![](images/nominal-short-rate-with-money.png)
> - Nominal Short Rate: 단기 명목 금리
> - Money (%PGDP): 통화 (잠재 GDP%)
